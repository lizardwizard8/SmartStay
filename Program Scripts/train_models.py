...
joblib.dump(temp_model,      MODEL_DIR / "temp_reg.pkl")        # ➌
joblib.dump(dimmer_model,    MODEL_DIR / "dimmer_reg.pkl")      # ➌
joblib.dump(minibar_model,   MODEL_DIR / "minibar_model.pkl")   # ➌
joblib.dump(empty_start_mod, MODEL_DIR / "empty_start_reg.pkl") # ➌
joblib.dump(empty_end_mod,   MODEL_DIR / "empty_end_reg.pkl")   # ➌
joblib.dump(dir_model,       MODEL_DIR / "dir_model.pkl")       # ➌
